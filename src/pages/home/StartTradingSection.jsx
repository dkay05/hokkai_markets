// ============================================
// HOKKAI MARKETS - Start Trading Section
// ============================================
    ...
    <section className="section-padding bg-dark-800">
      <div className="section-container">
        <SectionHeader
          ...
          subtitle="Begin your trading journey with Hokkai Markets today"
        />
          ...
          {steps.map((step, i) => (
            <StaggerItem key={step.number}>
              <div className="card h-full text-center relative">
                {/* Step Number Badge */}
                <div className={`absolute -top-4 left-1/2 -translate-x-1/2 w-12 h-12 rounded-full ${step.bg} border-4 border-dark-800 flex items-center justify-center`}>
        ...
        <AnimatedSection animation="slideUp" delay={0.4} className="text-center mt-12">
          <Link to="/accounts" className="btn-primary text-lg px-8 py-4">
