// ============================================
// HOKKAI MARKETS - Vision, Mission & Values Section
// ============================================
      ...
      <div className="section-container">
        ...
        <div className="grid md:grid-cols-2 gap-6 mt-12 mb-16">
          <AnimatedSection animation="slideLeft">
            <div className="p-8 rounded-3xl bg-gradient-to-br from-red-accent/10 to-dark-600 border border-red-accent/20 h-full">
          ...
          <AnimatedSection animation="slideRight" delay={0.1}>
            <div className="p-8 rounded-3xl bg-gradient-to-br from-blue-500/10 to-dark-600 border border-blue-500/20 h-full">
              <div className="text-4xl mb-4">🚀</div>
