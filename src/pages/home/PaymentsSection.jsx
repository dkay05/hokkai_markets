// ============================================
// HOKKAI MARKETS - Deposits & Withdrawals Section
// ============================================
              ...
              <StaggerContainer className="grid grid-cols-2 md:grid-cols-3 gap-4">
                {paymentMethods.map((method) => (
                  <StaggerItem key={method.name}>
                    <div className="p-4 rounded-xl bg-dark-700 border border-white/5 hover:border-red-accent/20 transition-all text-center">
